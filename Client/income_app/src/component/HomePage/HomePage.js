          ...
          <div className="flex flex-wrap lg:items-center -mx-4">
            ...
            <div className="w-full md:w-1/2 px-4">
              <div className="relative mx-auto md:mr-0 max-w-max">
                <img
                  src="https://st5.depositphotos.com/35303328/65496/i/450/depositphotos_654964742-stock-photo-yellow-sheet-red-text-expenses.jpg"
                  //src="https://cdn.pixabay.com/photo/2015/01/28/22/20/bookkeeping-615384_1280.jpg"
                  //src="https://qph.cf2.quoracdn.net/main-qimg-27a3fbd404a24833ff5ee1498f628ce1"
                  alt="home"
                />
              </div>
            </div>
      ...
      <section className="relative py-24 md:pb-32 bg-white overflow-hidden">
        <div className="relative container px-4 mx-auto">
          ...
          <div className="relative max-w-4xl mx-auto">
            <img
              className="relative"
              src="https://cdn.corporatefinanceinstitute.com/assets/accounts-expenses.jpeg"
              //src="https://st5.depositphotos.com/35303328/65496/i/450/depositphotos_654964742-stock-photo-yellow-sheet-red-text-expenses.jpg"
              //src="https://cdn.pixabay.com/photo/2015/01/28/22/20/bookkeeping-615384_1280.jpg"
              alt="landing"
            />
